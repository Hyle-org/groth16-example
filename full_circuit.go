...
func (circuit *CollatzCircuit) CreateResetWitness(resetTo int) (witness.Witness, error) {
...
func (circuit *CollatzCircuit) CreateNextWitness(current int) (witness.Witness, error) {
	next := 0
	if current == 1 {
		next = 1
	}
